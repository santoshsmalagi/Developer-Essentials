...
Most optimizations are completely disabled at ‘-O0’ or if a ‘-O’ level is not set on the command line, even if individual optimization flags are specified. Similarly, ‘-Og’ suppresses many optimization passes.
