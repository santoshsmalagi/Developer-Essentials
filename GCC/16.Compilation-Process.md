...
```Shell
$ cpp helloWorld.c                        # writes pre-processed output to STDOUT
$ cpp helloWorld.c > helloWorld.i         # redirect preprocessed output to <filename>.i
```
...
```Shell
$ gcc -Wall -E main.c                                         # write preprocessed output to STDOUT
$ gcc -Wall -E main.c -o main.i                               # write preprocessed output to <filename.i>
$ gcc -Wall -E helloWorld.c -o helloWorld.i                   # write preprocessed output to <filename.i>
$ gcc -Wall -E -P helloWorld.c -o helloWorld.i                # a more compact output can be obtained by using the ``-P`` flag
```
...
```Shell
$ gcc -Wall -S hello.i           # converts preprocessed output <filename>.i to <assembly>.s
$ gcc -Wall -S main.i           
```
