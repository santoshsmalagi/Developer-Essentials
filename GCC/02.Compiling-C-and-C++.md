...
Consider the classic "Hello World" program in C written to a source file named "HelloWorld.c" as follows:
...
This generates a binary (or executable) named ``HelloWorld`` in the current working directory, which can be exectuted using:
