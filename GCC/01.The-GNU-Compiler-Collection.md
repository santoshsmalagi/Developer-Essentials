...
* * **Language specific**:
 * The GCC compiler is capable of compiling several languages, and some options apply to only one or two of them. For example, the C89 option only applies to C to specify that the 1989 standard be used.
* **Platform specific**:
